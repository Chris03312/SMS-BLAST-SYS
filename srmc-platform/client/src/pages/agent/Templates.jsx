...
export default function AgentTemplates() {
  ...
  const [editing, setEditing] = useState({ name: '', body: '', category: 'transactional', dlt_id: '' });
  ...
  function startNew() {
    setSelected(null);
    setCreating(true);
    setEditing({ name: '', body: '', category: 'transactional', dlt_id: '' });
    setError('');
  }
            ...
            <form style={{ padding: 18 }} onSubmit={handleSave}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <input
                  ...
                  value={editing.dlt_id}
                  onChange={e => setEditing(prev => ({ ...prev, dlt_id: e.target.value }))}
                  placeholder="e.g. DLT00123456"
                  style={{ fontSize: 12 }}
                />
              </div>
              {/* Preview */}
